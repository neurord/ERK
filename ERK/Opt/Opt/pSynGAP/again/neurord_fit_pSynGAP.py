...
exec(open('neurord_fit_pSynGAP.py').read())
'''
...
params = aju.optimize.ParamSet(P('phos_fwd_rate', 1e-6, min=0, max=0.001, xpath='//Reaction[@id="CKpCamCa4+SynGap--CKpCamCa4SynGap"]/forwardRate'),
                               P('phos_rev_rate', 1e-6, min=0, max=0.001, xpath='//Reaction[@id="CKpCamCa4+SynGap--CKpCamCa4SynGap"]/reverseRate'),
                               P('phos_kcat_rate', 1e-6, min=0, max=0.001, xpath='//Reaction[@id="CKpCamCa4SynGap--CKpCamCa4+pSynGap"]/forwardRate'))
